package com.gestankbratwurst.eproaddons.util.tasks;
...
public class TaskManager {
  ...
  public static TaskManager getInstance() {
    return TaskManager.instance == null ? new TaskManager(JavaPlugin.getPlugin(EproAddons.class)) : TaskManager.instance;
  }
  ...
  public TaskManager(final JavaPlugin plugin) {
  ...
  private static String extractNumber(final String input) {
  ...
  public CompletableFuture<BukkitTask> completeBukkitSync(final Runnable runnable) {
    return CompletableFuture.supplyAsync(() -> this.runBukkitAsync(runnable));
  }
