...
//  }
  ...
  @EventHandler
  public static void onEnchant(final PrepareItemEnchantEvent event) {
  ...
  @EventHandler
  public static void onAnvil(final PrepareAnvilEvent event) {
  ...
  public static ItemStack produceHead(final String base64) {
    final GameProfile gameProfile = new GameProfile(UUID.randomUUID(), "--INTERNAL--");

    gameProfile.getProperties().put("textures", new Property(base64, "textures"));
